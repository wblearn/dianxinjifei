    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkName(){
            	...
            	var divResult=document.getElementById("name_Msg");
            	if(name==""){
            		divResult.style.display="block";
            	}else{
            		divResult.style.display="none";
        ...
        <div id="main">           
            ...
            <form action="updateRole" method="post" class="main_form">
                ...
                <div class="input_info">
                	...
                	<s:textfield name="role.name" cssClass="width200" id="role_name" onblur="checkName()" ></s:textfield>
                    <span class="required">*</span>
                    <div class="validate_msg_medium error_msg" id="name_Msg" style="display:none" >不能为空，且为20长度的字母、数字和汉字的组合!</div>
                </div>                    
