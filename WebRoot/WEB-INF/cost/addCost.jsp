        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkName() {
            	...
            	if(costName == null || costName == "") {
            		...
            		$("#save_result_info").text("资费名称不能为空！");
            	...
            	$.post(
            		...
            		{"name":costName},
            		function(data) {
            			//data就是返回值，这里是json类型的Result返回的字符串，即Action中repeat属性值
            			var repeat = data;
            			if(repeat) {
            				//返回值为true，说明重复，给予提示
            				$("#nameMsg").text("资费名称重复，请重新输入！");
            				$("#save_result_info").text("资费名称重复，请重新输入！");
            				$("#nameMsg").addClass("error_msg");
            				nameFlag = false;
            			} else {
            				//如果不重复，将信息重置
            ...
            function save() { 
            	...
            	var timer = setInterval(function(){
            		...
            		if(nameFlag != undefined) {
            			//当nameFlag不是undefined时，说明异步请求执行完毕
            			clearInterval(timer);
            			//此时nameFalg已经有了一个结果，根据其结果判断是否可以提交
            			if(nameFlag) {
            				document.forms[0].submit();
            			} else {
            				showResultDiv(true); //开启大提示框
            				setTimeout(function(){
            					//2000ms后执行此funtion
            					showResultDiv(false); //关闭大提示框
            				}, 2000);
            			}
            		}
            	},200);
        ...
        <div id="main">            
            ...
            <form action="addCost" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input name="cost.name" id="costName" type="text" class="width300" onblur="checkName();"/>
                ...
                <div class="input_info">
                    ...
                    <span class="required">*</span>
                    <div class="validate_msg_long"class="validate_msg_long error_msg">0-99999.99之间的数值</div>
                </div>
